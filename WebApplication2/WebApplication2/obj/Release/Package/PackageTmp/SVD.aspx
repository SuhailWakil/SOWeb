				        ...
				        <div class="fileupload fileupload-new" data-provides="fileupload">
                            <span class="btn btn-primary btn-file">
                                ...
                                <span class="fileupload-exists">Change</span>     
                                    <input type="file" v-on:change="onFileChange" name="img_tcbmp" id="img_tcbmp"/>
                            </span>
                            <span class="fileupload-preview"></span>
                            <a href="#" class="close fileupload-exists" v-on:click="removeImage" data-dismiss="fileupload" style="float: none">×</a>
                        </div>
